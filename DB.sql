...
select * from skill;
drop procedure AsigSkillPersona;
delimiter //
create procedure AsigSkillPersona(in fecha date,in person int,in idSkill int)
begin
insert into persons_skill (registration_date,idpersons,idskill)values(fecha,person,idSkill);
end//
delimiter ;

call AsigSkillPersona("2021-06-06",1,1);
